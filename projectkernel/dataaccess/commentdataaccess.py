...
class CommentDataAccess(BaseDataAccess):
    ...
    def load(self):
        ...
        for id in self.m_config_parser.sections():
            ...
            c.set_user_id(self.m_config_parser[id]["user id"])
    ...
    def add_comment(self, cmt):
        ...
        newcmt.set_user_id(cmt.get_user_id())
        ...
        self.m_config_parser[newid]["user id"] = cmt.get_user_id()
