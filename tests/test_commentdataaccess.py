...
from projectkernel import CommentDataAccess
...
class TestCommentDataAccess(unittest.TestCase):
    ...
    def test_add_save(self):
        ...
        with open("test.ini", "rt") as f:
            ...
            self.assertEqual(f.readline(), "user id = user3\n")
    ...
    def test_add_autoid(self):
        ...
        with open("test.ini", "rt") as f:
            ...
            self.assertEqual(f.readline(), "user id = user1\n")
            ...
            self.assertEqual(f.readline(), "time = 06/10/15 12:00:00\n")
            self.assertEqual(f.readline(), "user id = user2\n")
            ...
            self.assertEqual(f.readline(), "user id = user4\n")
            self.assertEqual(f.readline(), "message = message3\n")
    ...
    def test_update_then_save(self):
        ...
        with open("test.ini", "rt") as f:
            ...
            self.assertEqual(f.readline(), "user id = user0\n")
